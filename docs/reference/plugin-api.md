# Plugin and IR API (autodoc)

Symbols for dialect plugins and advanced two-phase compile. Prefer
{doc}`application` for application code. Contract: {doc}`../IR_CONTRACT` ·
{doc}`../API`.
